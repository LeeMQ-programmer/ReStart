...
<div id="container">
	<form action="./boardInsert.do" method="post">
		<b>user_seq</b><input class="ipt" type="text" name="user_seq" id="user_seq"  required="required">
		<b>Title</b><input class="ipt" type="text" name="gonggo_title" id="gonggo_title" required="required">
		<b>COST</b><input class="ipt" type="text" name="gongo_cost" id="gongo_cost" required="required">
		<br>
		<br>
		<br>
