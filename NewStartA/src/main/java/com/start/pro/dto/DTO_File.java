...
public class DTO_File {
	...
	public DTO_File(String fileboard, String board_seq, String filename, String filerealname, String fileurl,
			String filetype, String user_seq, String file_del) {
		super();
		this.fileboard = fileboard;
		this.board_seq = board_seq;
		this.filename = filename;
	...
	public DTO_File(String fileboard, String board_seq, String filename, String filerealname, String fileurl, String user_seq) {
		super();
		this.fileboard = fileboard;
		this.board_seq = board_seq;
		this.filename = filename;
